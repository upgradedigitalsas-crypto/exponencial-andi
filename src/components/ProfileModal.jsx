...
export default function ProfileModal({ profile, onClose }) {
  ...
  useEffect(() => {
    const handleKey = (e) => {
      if (e.key === "Escape") photoZoom ? setPhotoZoom(false) : onClose();
    };
  ...
  return (
    <>
      {/* Outer — flex center, sheet contiene su propio scroll */}
      <div
        style={{
      ...
      >
        ...
        {/* Sheet: flex column, altura máxima = viewport - 48px */}
        <div
          style={{
        ...
        >
          ...
          <div style={{
            ...
            {/* Avatar anclado al fondo del banner */}
